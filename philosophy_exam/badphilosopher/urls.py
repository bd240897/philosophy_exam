...
urlpatterns = [
    ...
    path('lections_answer/<slug:slug>/', LectionsDetailedAnswerlView.as_view(), name='lections_detailed_answer'), #
    path('seminars_list/', SeminarsAnswerListView.as_view(), name='seminars_answer_list'),  #
    path('seminars_answer/<slug:slug>/', SeminarsDetailedAnswerlView.as_view(), name='seminars_detailed_answer'),  #
]
